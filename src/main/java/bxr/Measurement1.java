...
/**
 * Performs the time measurements to produce table 1 of paper.
 * Iterates over the different number of sample points.
 *
...
public class Measurement1 {
    ...
    public static void main(String args[]) throws Exception {
        ...
        int                 numPointsSet[] = { 54, 218, 872, 3490 };
        ...
        System.out.print("Barnes Interpolation Time Measurements 1\n");
        System.out.print("****************************************");
        ...
        for (int numPoints : numPointsSet) {
            System.out.println();
            System.out.println();
